...
/datum/game_mode/proc/initialize_post_marine_gear_list()
	...
	for(var/X in cargo_ammo_vendors)
		...
		CA.products = list(
						...
						/obj/item/ammo_magazine/pistol/hp = round(scale * 5),
		...
		CA.contraband = list(
						...
						/obj/item/ammo_magazine/pistol/holdout = round(scale * 12),
	...
	for(var/X in cargo_guns_vendors)
		...
		CG.products = list(
						...
						/obj/item/clothing/tie/storage/brown_vest = round(scale * 3),
						/obj/item/clothing/tie/holster = round(scale * 3),
						...
						/obj/item/storage/pouch/shotgun = round(scale * 5),
						...
						/obj/item/explosive/grenade/cloakbomb = round(scale * 6),
