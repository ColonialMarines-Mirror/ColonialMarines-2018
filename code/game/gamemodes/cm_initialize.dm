...
datum/game_mode/proc/initialize_special_clamps()
	...
	xeno_starting_num = min((ready_players/7), xeno_required_num, INFINITY) //(n, minimum, maximum)
	surv_starting_num = min((ready_players/25), 0, 8)
	merc_starting_num = min((ready_players/3), 1, INFINITY)
