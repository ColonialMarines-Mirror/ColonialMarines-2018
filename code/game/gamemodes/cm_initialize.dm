...
/datum/game_mode/proc/transform_xeno(datum/mind/ghost_mind)
	...
	if(is_queen)
		...
		to_chat(new_xeno, "Talk in Hivemind using <strong>:a</strong> (e.g. ':a My life for the hive!')")
	else
		...
		to_chat(new_xeno, "Talk in Hivemind using <strong>:a</strong> (e.g. ':a My life for the queen!')")
