...
/datum/job/upp/standard
	...
	generate_stored_equipment()
		var/L[] = list(
					WEAR_IN_J_STORE = /obj/item/weapon/gun/rifle/type71,
					...
					WEAR_IN_BACK = /obj/item/ammo_magazine/rifle/type71,
					WEAR_IN_BACK = /obj/item/ammo_magazine/rifle/type71,
					WEAR_IN_BACK = /obj/item/ammo_magazine/rifle/type71,
					WEAR_IN_BACK = /obj/item/ammo_magazine/rifle/type71
			)
	...
	equip(mob/living/carbon/human/H, L[] = generate_wearable_equipment() + generate_stored_equipment())
		. = ..(H, L)
