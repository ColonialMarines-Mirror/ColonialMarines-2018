...
/obj/machinery/vending/marine/cargo_guns
	...
	products = list(
					...
					/obj/item/clothing/tie/storage/brown_vest = 3,
					/obj/item/clothing/tie/holster = 3,
					...
					/obj/item/storage/pouch/shotgun = 5,
					...
					/obj/item/explosive/grenade/cloakbomb = 6,
	...
	contraband = list(
					...
					/obj/item/weapon/gun/pistol/holdout = 6
					// /obj/item/weapon/gun/smg/m39/elite = 0,
					// /obj/item/weapon/gun/rifle/m41a/elite = 0, //why does a USCM ship's vendor have a slot for company PMC elite weaponry
...
/obj/machinery/vending/marine/cargo_ammo
	...
	products = list(
					...
					/obj/item/ammo_magazine/pistol/hp = 5,
	...
	contraband = list(
					...
					/obj/item/ammo_magazine/pistol/holdout = 12
