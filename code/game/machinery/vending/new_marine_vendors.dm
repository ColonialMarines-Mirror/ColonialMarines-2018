...
/obj/machinery/marine_selector/clothes
	...
	listed_products = list(
							...
							list("Magazine pouch", 0, /obj/item/storage/pouch/magazine, (MARINE_CAN_BUY_R_POUCH|MARINE_CAN_BUY_L_POUCH), "orange"),
...
/obj/machinery/marine_selector/gear/medic
	...
	listed_products = list(
							...
							list("Firstaid kit", 2, /obj/item/storage/firstaid/regular, null, "black"),
							...
							list("Pillbottle (Tricordrazine)", 4, /obj/item/storage/pill_bottle/tricordrazine, null, "black"),
