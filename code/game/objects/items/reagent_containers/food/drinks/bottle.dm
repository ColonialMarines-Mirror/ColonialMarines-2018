...
/obj/item/reagent_container/food/drinks/bottle/sake
	name = "\improper Nanotrasen Sake"
	desc = "Sake made with ancient techniques passed down for thousands of years. Fermented in Iowa by the Nanotrasen Corporation."
