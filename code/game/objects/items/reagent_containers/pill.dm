...
/obj/item/reagent_container/pill/hypervene
	pill_desc = "A Hypervene pill. Rapidly purges chemicals, toxins and radiation. Causes pain and nausea."
	New()
		..()
		icon_state = randomized_pill_icons[13]
...
/obj/item/reagent_container/pill/tricordrazine
	pill_desc = "A Tricodrazine pill. Broad spectrum restorative chemical; slowly heals all damage types."
	New()
		..()
		icon_state = randomized_pill_icons[14]
