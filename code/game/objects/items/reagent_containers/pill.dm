...
/obj/item/reagent_container/pill/attack(mob/M, mob/user, def_zone)
	...
	if(M == user)
		...
		var/mob/living/carbon/human/H = M
		if(H.species.flags & IS_SYNTHETIC)
			to_chat(user, "<span class='notice'>They have a monitor for a head, where do you think you're going to put that?</span>")
			return
...
/obj/item/reagent_container/pill/antitox
	desc = "An anti-toxins pill. It neutralizes many common toxins."
	New()
		..()
...
/obj/item/reagent_container/pill/tox
	desc = "A toxins pill. It's highly toxic."
...
/obj/item/reagent_container/pill/adminordrazine
	desc = "An Adminordrazine pill. It's magic. We don't have to explain it."
...
/obj/item/reagent_container/pill/stox
	desc = "A sleeping pill commonly used to treat insomnia."
...
/obj/item/reagent_container/pill/kelotane
	desc = "A Kelotane pill. Used to treat burns."
...
/obj/item/reagent_container/pill/paracetamol
	desc = "A Paracetamol pill. Painkiller for the ages."
...
/obj/item/reagent_container/pill/tramadol
	desc = "A Tramadol pill. A simple painkiller."
...
/obj/item/reagent_container/pill/methylphenidate
	desc = "A Methylphenidate pill. This improves the ability to concentrate."
...
/obj/item/reagent_container/pill/citalopram
	desc = "A Citalopram pill. A mild anti-depressant."
...
/obj/item/reagent_container/pill/inaprovaline
	desc = "An Inaprovaline pill. Used to stabilize patients."
...
/obj/item/reagent_container/pill/dexalin
	desc = "A Dexalin pill. Used to treat oxygen deprivation."
...
/obj/item/reagent_container/pill/spaceacillin
	desc = "A Spaceacillin pill. Used to treat infected wounds and slow down viral infections."
...
/obj/item/reagent_container/pill/happy
	desc = "A Happy Pill! Happy happy joy joy!"
...
/obj/item/reagent_container/pill/zoom
	desc = "A Zoom pill! Gotta go fast!"
...
/obj/item/reagent_container/pill/russianRed
	desc = "A Russian Red pill. A very dangerous radiation-countering substance."
...
/obj/item/reagent_container/pill/peridaxon
	desc = "A Peridaxon pill. Heals internal organ damage."
...
/obj/item/reagent_container/pill/imidazoline
	desc = "An Imidazoline pill. Heals eye damage."
...
/obj/item/reagent_container/pill/alkysine
	desc = "An Alkysine pill. Heals brain damage."
...
/obj/item/reagent_container/pill/bicaridine
	desc = "A Bicaridine pill. Heals brute damage."
...
/obj/item/reagent_container/pill/quickclot
	desc = "A Quickclot pill. Stabilizes internal bleeding temporarily."
...
/obj/item/reagent_container/pill/ultrazine
	desc = "An Ultrazine pill. A highly-potent, long-lasting combination CNS and muscle stimulant. Extremely addictive."
