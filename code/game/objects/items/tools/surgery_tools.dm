...
/obj/item/tool/surgery/xn_autopsy
...
/obj/item/tool/surgery/xn_autopsy/verb/reset()
	set category = "IC"
...
/obj/item/tool/surgery/xn_autopsy/attack(mob/living/carbon/Xenomorph/T as mob, mob/living/user as mob)
