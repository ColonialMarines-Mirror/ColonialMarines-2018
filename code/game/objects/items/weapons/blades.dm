/obj/item/weapon/claymore
	...
	suicide_act(mob/user)
		user.visible_message("\red <b>[user] is falling on the [src.name]! It looks like \he's trying to commit suicide.</b>")
		return(BRUTELOSS)
...
/obj/item/weapon/katana
	...
	suicide_act(mob/user)
		user.visible_message("\red <b>[user] is slitting \his stomach open with the [src.name]! It looks like \he's trying to commit seppuku.</b>")
		return(BRUTELOSS)
...
/obj/item/weapon/combat_knife
	...
	suicide_act(mob/user)
		user.visible_message(pick("\red <b>[user] is slitting \his wrists with the [src.name]! It looks like \he's trying to commit suicide.</b>", \
