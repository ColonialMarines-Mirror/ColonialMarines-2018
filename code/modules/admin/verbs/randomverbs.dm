...
/client/proc/cmd_admin_delete(atom/O as obj|mob|turf in world)
	...
	if (alert(src, "Are you sure you want to delete:\n[O]\nat ([O.x], [O.y], [O.z])?", "Confirmation", "Yes", "No") == "Yes")
		...
		message_admins("[key_name_admin(usr)] deleted [O] at ([O.x],[O.y],[O.z]) (<A HREF='?_src_=holder;adminplayerobservejump=\ref[usr]'>JMP</A>) (<A HREF='?_src_=holder;adminplayerfollow=\ref[usr]'>FLW</a>)", 1)
