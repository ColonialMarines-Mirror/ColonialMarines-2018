...
/client/verb/togglemidis()
	...
	src.prefs.save_preferences() // We WIll save the change - it'll be a temporary switch instead of permanent, but they can still make it permanent in character setup.
