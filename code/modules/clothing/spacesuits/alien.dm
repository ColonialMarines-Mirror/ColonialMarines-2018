...
/obj/item/clothing/suit/space/vox
	...
	sprite_sheets = list("Vox" = 'icons/mob/species/vox/suit.dmi', "Vox Armalis" = 'icons/mob/species/armalis/suit.dmi')
...
/obj/item/clothing/head/helmet/space/vox
	...
	species_restricted = list("Vox","Vox Armalis")
	sprite_sheets = list("Vox" = 'icons/mob/species/vox/head.dmi', "Vox Armalis" = 'icons/mob/species/armalis/head.dmi')
...
/obj/item/clothing/gloves/yellow/vox
	...
	species_restricted = list("Vox","Vox Armalis")
	sprite_sheets = list("Vox" = 'icons/mob/species/vox/gloves.dmi',"Vox Armalis" = 'icons/mob/species/armalis/gloves.dmi')
...
/obj/item/clothing/shoes/magboots/vox
	...
	species_restricted = list("Vox","Vox Armalis")
	sprite_sheets = list("Vox Armalis" = 'icons/mob/species/armalis/feet.dmi')
