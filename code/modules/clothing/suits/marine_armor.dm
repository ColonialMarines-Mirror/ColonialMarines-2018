...
/obj/item/clothing/suit/storage/marine/tanker
	...
	desc = "A modified and refashioned suit of M3 Pattern armor designed to be worn by vehicle crew. While the suit is a bit more encumbering to wear, it offers the loader a degree of protection that would otherwise not be enjoyed."
	icon_state = "tanker"
	armor = list(melee = 50, bullet = 60, laser = 45, energy = 40, bomb = 40, bio = 15, rad = 15)
...
/obj/item/clothing/suit/storage/marine/specialist
	...
	icon_state = "xarmor"
	armor = list(melee = 80, bullet = 110, laser = 80, energy = 65, bomb = 80, bio = 20, rad = 20)
...
/obj/item/clothing/suit/storage/marine/MP
	...
	desc = "A standard M2 Pattern Chestplate. Protects the chest from ballistic rounds, bladed objects and accidents. It has a small leather pouch strapped to it for limited storage."
	icon_state = "mp"
...
/obj/item/clothing/suit/storage/marine/UPP
	...
	desc = "Standard body armor of the UPP military, the UM5 (Union Medium Mk 5) is a medium body armor, roughly on par with the M3 pattern body armor."
	icon_state = "upp_armor"
	slowdown = SLOWDOWN_ARMOR_MEDIUM
	flags_marine_armor = ARMOR_LAMP_OVERLAY
	armor = list(melee = 60, bullet = 60, laser = 50, energy = 60, bomb = 40, bio = 10, rad = 10)

/obj/item/clothing/suit/storage/marine/UPP/commando
...
/obj/item/clothing/suit/storage/marine/UPP/heavy
	name = "\improper UH7 heavy plated armor"
	desc = "An extremely heavy duty set of body armor, the UH7 (Union Heavy Mk 7) is known for being a rugged set of armor, capable of taking immesnse punishment."
...
/obj/item/clothing/suit/storage/marine/freelancer
	...
	desc = "A armored protective chestplate scrapped together from various plates. It keeps up remarkably well, as the craftsmanship is solid."
...
/obj/item/clothing/suit/storage/militia
	...
	desc = "The hauberk of a colonist militia member, created from boiled leather and some modern armored plates."
	icon = 'icons/obj/clothing/cm_suits.dmi'
...
/obj/item/clothing/suit/storage/marine/veteran/mercenary
	...
	desc = "A set of grey, heavy ceramic armor with dark blue highlights. It is the standard uniform of a unknown mercenary group"
...
/obj/item/clothing/suit/storage/marine/veteran/mercenary/engineer
	...
	desc = "A set of blue armor with yellow highlights built for protection while building in highly dangerous environments. It is a specialized uniform of a unknown mercenary group"
