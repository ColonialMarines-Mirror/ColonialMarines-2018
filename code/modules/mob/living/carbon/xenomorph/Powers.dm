...
/mob/living/carbon/Xenomorph/proc/Savage(var/mob/living/carbon/M)
	...
	M.attack_alien(src,  extra_dam, FALSE, TRUE, TRUE) //Inflict a free attack on pounce that deals +1 extra damage per 4 plasma stored, up to 35 or twice the max damage of an Ancient Runner attack.
