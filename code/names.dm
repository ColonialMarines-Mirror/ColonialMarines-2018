...
var/list/first_names_male_pmc = file2list("config/names/first_male_pmc.txt")
var/list/first_names_female_pmc = file2list("config/names/first_female_pmc.txt")
...
var/list/last_names_pmc = file2list("config/names/last_name_pmc.txt")
