...
var/list/first_names_male_russian = file2list("config/names/first_male.txt")
var/list/first_names_female_russian = file2list("config/names/first_female.txt")
var/list/last_names = file2list("config/names/last_name.txt")
var/list/last_names_russian = file2list("config/names/last_name_russian.txt")
var/list/clown_names = file2list("config/names/clown.txt")
var/list/moth_first = file2list("config/names/moth_first.txt")
var/list/moth_last = file2list("config/names/moth_last.txt")
